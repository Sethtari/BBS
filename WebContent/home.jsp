...
<body><div class="postTitle">ホーム</div><br />
 ...
 <form action="./" method="get">
			カテゴリー : <select name="category">
				<option value="">
					...
					<c:if test="${category.equals(categories.postsCategory)}">
			...
			<input type="hidden" name="firstTimeAccess" value="1">　　　
		...
		<div id="contentsArea"><c:forEach items="${userPosts}" var="userPost">
